...
class LandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create land" do
    assert_difference('Land.count') do
      post lands_url, params: { land: { description: @land.description, image: @land.image, name: @land.name } }
    end
  ...
  test "should update land" do
    patch land_url(@land), params: { land: { description: @land.description, image: @land.image, name: @land.name } }
